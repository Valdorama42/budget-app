    ...
    {#each itemState.itemsForCategory(categoryId) as item}
      <li class="px-2 pb-2 pt-2">
        <div class="flex flex-1 items-center gap-2">
          <button
            type="button"
            class="flex flex-1 items-center justify-between rounded-lg px-3 py-2 text-left text-sm text-slate-700 transition hover:bg-indigo-50/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-300"
          ...
          >
            ...
            <span class="flex items-center gap-2">
              ...
              <input
                class="w-24 rounded-md border border-slate-200 bg-white px-2 py-1 text-right text-sm font-medium text-slate-700 focus:border-indigo-400 focus:outline-none focus:ring-2 focus:ring-indigo-200"
                type="number"
                step="0.01"
                inputmode="decimal"
          ...
          <button
            type="button"
            class="inline-flex items-center justify-center rounded-lg border border-slate-200 px-2 py-1 text-xs font-semibold text-rose-600 transition hover:border-rose-200 hover:bg-rose-50"
